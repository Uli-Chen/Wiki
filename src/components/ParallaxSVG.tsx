...
import "./ParallaxSVG.css"; // 導入 CSS 文件

// 註冊 GSAP 插件
gsap.registerPlugin(ScrollTrigger);

const ParallaxSVG: React.FC = () => {
  const parallaxRef = useRef<SVGSVGElement>(null);
  ...
  useEffect(() => {
    ...
    // 選擇所有带有 data-depth 的 SVG 圖層
    const layers = gsap.utils.toArray(
      parallaxRef.current.querySelectorAll("[data-depth]")
    );

    layers.forEach((layer: any) => {
      // 根據 data-depth 值為每個圖層創建視差動畫
    ...
    // 清理函數：在組件卸載時銷毀 ScrollTrigger 和動畫
    return () => {
      ...
      >
        ...
        <g id="layers">
          ...
          <g id="six" data-depth="10">
            <path
              d="M169.77,224.7s42-6.63,57.15-18.74c11.76-10.1,16-5.39,18.07-3.85s7.14,7.59,14.28,7.31,39.5,27,44.54,27.11-74,21.15-90.59,16.34S169.77,224.7,169.77,224.7Z"
              fill="url(#linear-gradient-2)"
            />
            <path
              d="M254.77,218.51c-2-1-3-6-4-6-8.79-1-6.14-9.58-12.54-12.78-2.68.32-6.31,1.94-11.31,6.23-15.13,12.11-57.15,18.74-57.15,18.74s26.89,23.36,43.45,28.17c9,2.61,36.36-2.39,58.72-7.53C267,236,263,226.07,254.77,218.51Z"
              fill="url(#linear-gradient-3)"
            />
            <path
              d="M303.81,236.53c-5-.1-37.39-27.4-44.54-27.11s-12.18-5.77-14.28-7.31c-1.21-.88-3.12-2.81-6.76-2.38,6.4,3.2,3.75,11.81,12.54,12.78,1,0,2,5,4,6C263,226.07,267,236,271.94,245.34,290.81,241,306.12,236.57,303.81,236.53Z"
              fill="url(#linear-gradient-4)"
            />
            <path
              d="M553.54,179.82c-2.8-1.9-5.64-3.78-8.22-5.76-2-1.53-7.56-7.66-9.74-8-5.14-.89-12.64,9.84-15.76,13.43-5.07,5.85-9.64,12-15.4,17.57-4.53,4.37-10,15.35-16.7,16.7-5.22,1-12.63-4.93-17.09-7.7-6.89-4.28-13.13-8.84-19.52-13.72-5.89-4.48-9.3-9.21-14-14.93-2.61-3.18-6.51-7.61-10.6-9-6.44-2.21-3.8.55-8.59,1.81-10,2.62-9.11-9.51-18.15-10-6.8-.37-12.87,10.46-16.35,15.51-5.4,7.85-12.72,14.48-19.63,21.17-5.51,5.33-12.23,9.24-19.08,12.45-10.68,5-23.36,13-34.94,14.87l39.33,36.67c25.37,0,51.84,2.46,77-1.12,23.26-3.31,46.24-7.88,69.38-12.23,19.56-3.69,38.85-7.41,58.1-12.12Z"
              fill="url(#linear-gradient-5)"
            />
            <path
              d="M470.63,206c-6.89-4.28-13.13-8.84-19.52-13.72-5.89-4.48-9.3-9.21-14-14.93-2.61-3.18-6.51-7.61-10.6-9-4.43-1.52-4.56-.69-5.77.39,4.94,1.78,7.54,7.54,9,12.75,6,17,16,30,25,45,6,9.73,15.34,16.11,21.76,24.57l18.91-3.58,10.74-2-19.69-31.62C481.39,213.87,474.75,208.59,470.63,206Z"
              fill="url(#linear-gradient-6)"
            />
            <path
              d="M162.42,202.14c-12.66-6.87-25.2-16.23-37.35-24.11-6.32-4.09-9.76-5.52-17.14-3.18-10.23,3.24-9.3.63-16.92-6.15-7.16-6.37-11.07-5-19.06-.52a179.13,179.13,0,0,0-20.68,13.69C43.34,188,32.72,190.42,23.78,195,15.1,199.43,8.68,204.62,0,206.65v58.89c35.13.09,70.29.46,105.41,0,24.42-.34,48.86-2.66,73.48-2.66h54.88c5.76,0,36.38,4.07,39.36-2-19.56-12.14-40-20.76-60.36-32.31C196.16,219.05,179.38,211.35,162.42,202.14Z"
              fill="url(#linear-gradient-7)"
            />
            <path
              d="M212.77,228.5c-16.61-9.45-33.39-17.15-50.35-26.36-12.66-6.87-25.2-16.23-37.35-24.11-6.32-4.09-9.76-5.52-17.14-3.18-3.31,1.05-5.44,1.48-7.08,1.36.84.24,1.46.69.92,2.3,5,0,10-1,14,1,8,4,5,16,11,22,16.77,19.57,35.28,36.54,45,61.41,2.37,0,4.74-.07,7.12-.07h54.88c5.76,0,36.38,4.07,39.36-2C253.57,248.67,233.1,240.05,212.77,228.5Z"
              fill="url(#linear-gradient-8)"
            />
          </g>
          <g id="five" data-depth="20">
            <path
              d="M553.54,200.28c-.26.1-.53.2-.79.28-5,1.64-9.53,1.63-14.75,1.62-11.64,0-23.07.22-34.41-1.31-6.52-.89-17.14-2.55-23.14.28-3.63,1.71-5.06,5-9.36,6.39-2.92,1-6.84.92-9.94,1.31a130,130,0,0,1-15.31.66c-6.49,0-8.38,1.61-14,4.65a192.13,192.13,0,0,1-28.88,12.13c-17.75,6-31-5.33-47.27-9.59-13.46-3.52-22.39-13.47-37-12.52-14.22.92-21.45,11.68-33.47,17.84-9.17,4.69-19.94,6.56-29.71,9.53s-19.21,6.9-28.92,10.33c-10.09,3.56-20.13,7.2-30.52,10.47-8,2.52-16.17,4.22-24.29,6.49-3.85,1.08-9.3,1.62-12.05,4.62,7.19,6.43,20.51,7.42,29.59,9.44,12.33,2.75,24.48,6,36.81,8.81,23.66,5.3,47.69,6.28,71.6,9.93,18.39,2.8,36.46,7,55,9.22,22.81,2.78,45.31,2.65,68.28,2.65,44.28,0,88.38,1.57,132.6,1.93Z"
              fill="url(#linear-gradient-9)"
            />
            <path
              d="M386.77,257.51c-8-7-12-18-21-23-8-5-17-6-26-8-6-1-7-9-10-15-1.74-4.35-7.27-5.67-12-7.26C304.11,205.52,296.92,216,285.13,222c-9.17,4.69-19.94,6.56-29.71,9.53s-19.21,6.9-28.92,10.33c-10.09,3.56-20.13,7.2-30.52,10.47-8,2.52-16.17,4.22-24.29,6.49-3.85,1.08-9.3,1.62-12.05,4.62,7.19,6.43,20.51,7.42,29.59,9.44,12.33,2.75,24.48,6,36.81,8.81,23.66,5.3,47.69,6.28,71.6,9.93,18.39,2.8,36.46,7,55,9.22,22.81,2.78,45.31,2.65,68.28,2.65q8.38,0,16.76.07c-1.27-1.05-2.58-2.08-3.93-3.07C414.77,288.51,403.77,271.51,386.77,257.51Z"
              fill="url(#linear-gradient-10)"
            />
            <path
              d="M553.54,304.19V200.28c-.26.1-.53.2-.79.28-5,1.64-9.53,1.63-14.75,1.62-11.64,0-23.07.22-34.41-1.31-6.52-.89-17.14-2.55-23.14.28-3.63,1.71-5.06,5-9.36,6.39-2.92,1-6.84.92-9.94,1.31a130,130,0,0,1-15.31.66c-6.49,0-8.38,1.61-14,4.65a192.13,192.13,0,0,1-28.88,12.13c-10.22,3.47-18.94,1.18-27.62-2.21a16.07,16.07,0,0,0,5.48,3.43C441.27,247.08,501,269.83,553.54,304.19Z"
              fill="url(#linear-gradient-11)"
            />
            <path
              d="M380.77,227.51a16.07,16.07,0,0,1-5.48-3.43c-6.38-2.49-12.74-5.57-19.65-7.38-13.46-3.52-22.39-13.47-37-12.52l-.8.07c4.7,1.59,10.23,2.91,12,7.26,3,6,4,14,10,15,9,2,18,3,26,8,9,5,13,16,21,23,17,14,28,31,47,43,1.35,1,2.66,2,3.93,3.07,38.66.31,77.2,1.55,115.84,1.86v-1.25C501,269.83,441.27,247.08,380.77,227.51Z"
